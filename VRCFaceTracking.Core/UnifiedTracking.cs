...
#pragma warning disable CS0618
        ...
        /// </summary>
        public static readonly Parameter[] AllParameters = AllParameters_v2.Concat(EmotionOscParameters.Parameters).Concat(AllParameters_v1).Concat(HeadParameters).ToArray();
